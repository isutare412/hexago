...
type DonationRequest struct {
	...
	DonatorId string `protobuf:"bytes,1,opt,name=donatorId,proto3" json:"donatorId,omitempty"`
	DonateeId string `protobuf:"bytes,2,opt,name=donateeId,proto3" json:"donateeId,omitempty"`
...
func (x *DonationRequest) GetDonatorId() string {
	if x != nil {
		return x.DonatorId
	}
	return ""
...
func (x *DonationRequest) GetDonateeId() string {
	if x != nil {
		return x.DonateeId
	}
	return ""
...
func (x *DonationRequest) GetCents() int64 {
	if x != nil {
		return x.Cents
	}
	return 0
...
var file_protos_payment_proto_rawDesc = []byte{
	...
	0x63, 0x0a, 0x0f, 0x44, 0x6f, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x64,
	0x12, 0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x6e, 0x61, 0x74, 0x65, 0x65, 0x49, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x6e, 0x61, 0x74, 0x65, 0x65, 0x49, 0x64, 0x12, 0x14,
	0x0a, 0x05, 0x63, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63,
	0x65, 0x6e, 0x74, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x70,
...
var file_protos_payment_proto_goTypes = []interface{}{
	(*DonationRequest)(nil), // 0: payment.DonationRequest
}
